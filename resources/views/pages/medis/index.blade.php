...
<div class="row g-5 g-xl-8">
    <div class="col-xl-12">
        <div class="row g-5 g-xl-8">
            <div class="col-xl-12">
                ...
                <div class="card mb-5 mb-xl-8 border-0 shadow-sm" style="border-radius: 12px;">
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            ...
                            <span class="text-muted mt-1 fw-semibold fs-7">Saring data medis berdasarkan kriteria</span>
                        </h3>
                    </div>
                    <div class="card-body pb-10 pt-0">
                        <div class="row g-8">
                            <div class="col-md-6">
                                <label class="form-label fs-7 fw-bold text-gray-700">Klasifikasi:</label>
                                <select class="form-select form-select-solid" id="filter_klasifikasi" data-control="select2" data-placeholder="Semua Klasifikasi" data-allow-clear="true">
                                    <option></option>
                ...
                <div class="card card-xl-stretch mb-5 mb-xl-8 border-0 shadow-sm" style="border-radius: 12px;">
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold fs-3 text-gray-900">Data Ahli Medis / Non Medis</span>
                    ...
                    <div class="card-body py-4">
                        <div class="table-responsive">
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="table_medis">
                                <thead>
                                    <tr class="fw-bold text-muted bg-light">
                                        ...
                                        <th class="min-w-150px">Akun User</th>
                                        <th class="min-w-100px">NIK</th>
                                        <th class="min-w-150px">Jenis Kelamin</th>
                                        <th class="min-w-150px">File Dokumen</th>
        ...
        <!--begin::Modal - Add/Edit Medis-->
        <div class="modal fade" id="kt_modal_medis" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header" id="kt_modal_medis_header">
                        <h2 class="fw-bold" id="modalTitle">Tambah Data Medis</h2>
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        <form id="formMedis" class="form" action="#" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="medis_id" id="medis_id">
                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade show active" id="kt_tab_akun_pribadi" role="tabpanel">
                                    ...
                                    <h4 class="fw-bold mb-5 text-primary">B. Identitas & Biodata</h4>
                                    <div class="row g-9 mb-8">
                                        <div class="col-md-6 fv-row">
                                            <label class="required fs-6 fw-semibold mb-2">Nama Lengkap (Sesuai KTP & Gelar)</label>
                                            <input type="text" class="form-control form-control-solid" placeholder="Cth: Dr. Fulan" name="name" id="name" />
                                            <div class="invalid-feedback" id="nameError"></div>
                                        </div>
                                        <div class="col-md-6 fv-row">
                                            <label class="required fs-6 fw-semibold mb-2">Klasifikasi Asal</label>
                                            <select class="form-select form-select-solid" name="klasifikasi" id="klasifikasi" data-control="select2" data-hide-search="true" data-placeholder="Pilih klasifikasi">
                                                <option value=""></option>
                                                <option value="dokter">Dokter</option>
                                                <option value="perawat">Perawat</option>
                                                <option value="masseur">Masseur</option>
                                            </select>
                                            <div class="invalid-feedback" id="klasifikasiError"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex flex-column mb-8 fv-row">
                                        ...
                                        <input type="text" class="form-control form-control-solid" placeholder="Contoh: S1 Pendidikan Keperawatan" name="last_education" id="last_education" />
                                ...
                                <div class="tab-pane fade" id="kt_tab_dokumen" role="tabpanel">
                                    ...
                                    <h4 class="fw-bold mb-5 text-primary">C. Berkas Pendukung Medis</h4>
                                    <div class="alert alert-dismissible bg-light-info border border-info d-flex flex-column flex-sm-row w-100 p-5 mb-10">
                                        ...
                                        <div class="d-flex flex-column pe-0 pe-sm-10">
                                            <h5 class="mb-1">Informasi Pengunggahan</h5>
                                    ...
                                    <div class="row g-9 mb-8">
                                        <div class="col-md-6 fv-row">
                                            <label class="fs-6 fw-semibold mb-2">File Foto Pribadi (Pas Foto)</label>
                                    ...
                                    <div class="row g-9 mb-8">
                                        <div class="col-md-6 fv-row">
                                            <label class="fs-6 fw-semibold mb-2">Sertifikat Pendidikan</label>
                                        ...
                                        <div class="col-md-6 fv-row">
                                            <label class="fs-6 fw-semibold mb-2">Sertifikat Kompetensi Keahlian (STR)</label>
                                            <input type="file" class="form-control form-control-solid" name="competency_certificate_path" id="competency_certificate_path" accept=".pdf,.jpg,.jpeg,.png" />
                                            <div class="invalid-feedback" id="competency_certificate_pathError"></div>
                                            <div class="mt-1" id="competency_certificate_path_viewer"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-9 mb-8">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            <label class="fs-6 fw-semibold mb-2">SK Pengangkatan Medis</label>
                                            <input type="file" class="form-control form-control-solid" name="sk_appointment_path" id="sk_appointment_path" accept=".pdf,.jpg,.jpeg,.png" />
                                            <div class="invalid-feedback" id="sk_appointment_pathError"></div>
                                            <div class="mt-1" id="sk_appointment_path_viewer"></div>
                                        </div>
                                    </div>
        ...
        <script src="{{ asset('js/pages/master/medis.js') }}"></script>
        @endsection