                ...
                <div class="card mb-5 mb-xl-8 border-0 shadow-sm" style="border-radius: 12px;">
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            ...
                            <span class="text-muted mt-1 fw-semibold fs-7">Saring data atlet berdasarkan kriteria</span>
                        </h3>
                    </div>
                    <div class="card-body pb-10 pt-0">
                        <div class="row g-8">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select form-select-solid" id="filter_klasifikasi_id" data-control="select2" data-placeholder="Semua Klasifikasi" data-allow-clear="true">
                                    <option></option>
                                    @foreach($klasifikasis as $k)
                                    <option value="{{ $k->id }}">{{ $k->kode_klasifikasi }} - {{ $k->nama_klasifikasi }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade show active" id="kt_tab_akun_pribadi" role="tabpanel">
                                    ...
                                    <div class="row g-9 mb-8">
                                        ...
                                        <div class="col-md-4 fv-row">
                                            <label class="required fs-6 fw-semibold mb-2">Jenis Disabilitas</label>
                                            <select class="form-select form-select-solid" name="jenis_disabilitas_id" id="jenis_disabilitas_id" data-control="select2" data-dropdown-parent="#kt_modal_atlet" data-placeholder="Pilih Jenis Disabilitas">
                                                <option value=""></option>
                                                @foreach ($jenisDisabilitas as $jenis)
                                                <option value="{{ $jenis->id }}">{{ $jenis->nama_jenis }}</option>
                                                @endforeach
                                            </select>
                                            <div class="invalid-feedback" id="jenis_disabilitas_idError"></div>
                                        </div>
                                    </div>
